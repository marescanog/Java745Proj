...
public class LifelinePhoneFriend extends Lifeline {
    ...
    public void runLifeline() {
        ...
        friendConfidence = random.nextInt(10) + 1; // Generate friend's confidence level
    ...
    public void reprintResult() {
           ...
           case 10:
               System.out.println("I'm absolutely certain, it's " + Question.letterChoices[GameSetting.getCurrentQuestion().getCorrectAnsIndex()]);
               break;
           case 9:
               System.out.println("I'm almost positive it's " + Question.letterChoices[GameSetting.getCurrentQuestion().getCorrectAnsIndex()]);
               break;
           case 8:
               System.out.println("I'm quite confident the answer is " + Question.letterChoices[GameSetting.getCurrentQuestion().getCorrectAnsIndex()]);
               break;
           case 7:
               System.out.println("I have a strong feeling it might be " + Question.letterChoices[GameSetting.getCurrentQuestion().getCorrectAnsIndex()]);
               break;
           case 6:
               System.out.println("I think there's a good chance it's " + Question.letterChoices[GameSetting.getCurrentQuestion().getCorrectAnsIndex()]);
               break;
           case 5:
               int randomChoice = random.nextInt(GameSetting.getCurrentQuestion().getChoices().length);
               System.out.println("I'm unsure, but maybe it's " + Question.letterChoices[randomChoice]);
               break;
           case 4:
               int anotherRandomChoice = random.nextInt(GameSetting.getCurrentQuestion().getChoices().length);
               System.out.println("I'm not entirely sure, but perhaps it's " + Question.letterChoices[anotherRandomChoice]);
               break;
           case 3:
               int closerChoice = getCloserChoice(GameSetting.getCurrentQuestion().getCorrectAnsIndex(), GameSetting.getCurrentQuestion().getChoices().length);
               System.out.println("Considering all options, it could be " + Question.letterChoices[closerChoice]);
               break;
           case 2:
               int veryCloseChoice = getVeryCloseChoice(GameSetting.getCurrentQuestion().getCorrectAnsIndex(), GameSetting.getCurrentQuestion().getChoices().length);
